 ...
 */
final class Version20260120130350 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pizza ADD updated_at DATETIME DEFAULT NULL, DROP update_at');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pizza ADD update_at VARCHAR(255) DEFAULT NULL, DROP updated_at');
    }
}
